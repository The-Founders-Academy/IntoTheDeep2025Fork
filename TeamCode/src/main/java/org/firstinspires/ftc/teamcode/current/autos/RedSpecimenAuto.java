...
import org.firstinspires.ftc.teamcode.current.commands.RedSpecimenCommandRunner;
...
@Autonomous
public class RedSpecimenAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        CommandScheduler.getInstance().schedule(  new RedSpecimenCommandRunner(m_mecanumDrive, m_armSubsystem));
