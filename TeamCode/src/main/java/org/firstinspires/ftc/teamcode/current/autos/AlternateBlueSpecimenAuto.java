...
@Autonomous
public class AlternateBlueSpecimenAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        m_mecanumDrive = new Mecanum2025(hardwareMap, mecanumConfigs, new Pose2d(-42.38, 159.3, Rotation2d.fromDegrees(270)), BaseMecanumDrive.Alliance.BLUE); // y was 159.3
