...
public class BlueSampleAuto extends CommandOpMode {
    ...
    public void initialize() {
        ...
        m_mecanumDrive = new Mecanum2025(hardwareMap, mecanumConfigs, new Pose2d(42, 161, Rotation2d.fromDegrees(270)), BaseMecanumDrive.Alliance.BLUE);
        m_armSubsystem = new Arm2025(hardwareMap);


        CommandScheduler.getInstance().schedule(  new BlueSampleCommandRunner(m_mecanumDrive, m_armSubsystem));
    }
}
