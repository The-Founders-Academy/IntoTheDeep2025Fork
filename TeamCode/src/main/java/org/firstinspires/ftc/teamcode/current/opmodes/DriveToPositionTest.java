...
public class DriveToPositionTest extends CommandOpMode {
    ...
    public void initialize() {
        ...
        m_mecanumDrive = new Mecanum2025(hardwareMap, mecanumConfigs, new Pose2d(0, 0, Rotation2d.fromDegrees(0)));
        ...
        m_driver.buttonX().whenPressed(new DriveToPosition(m_mecanumDrive, new Pose2d(0,0, Rotation2d.fromDegrees(180))));
